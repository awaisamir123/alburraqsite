...
?>
<?php global $post; ?>
<?php $pf_video_embed = get_post_meta( $post->ID, '_tcsn_pf_video_embed', true ); ?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  ...
  <div class="post-meta clearfix"> <span class="post-format-icon"><a href="<?php echo get_post_format_link('video'); ?>"><i class="icon-video2"></i></a></span>
