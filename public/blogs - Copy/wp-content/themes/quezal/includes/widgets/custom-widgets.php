...
<div class="widget-contact-info">
  ...
  <div class="widget-contact-text widget-email"><a href="mailto:<?php echo esc_attr( $instance['email'] ); ?>">
...
<ul class="social">
  ...
  <li><a href="<?php echo esc_url( $instance['twitter'] ); ?>" target="_blank" title="<?php _e( 'twitter', 'tcsn_theme' ); ?>" data-toggle="tooltip" data-placement="<?php echo $instance['tooltippos']; ?>"><i class="icon-twitter2"></i></a></li>
  <?php endif; ?>
  ...
  <li><a href="mailto:<?php echo esc_attr( $instance['mail'] ); ?>" target="_blank" title="<?php _e( 'mail', 'tcsn_theme' ); ?>" data-toggle="tooltip" data-placement="<?php echo $instance['tooltippos']; ?>"><i class="icon-mail"></i></a></li>
  <?php endif; ?>
</ul>
