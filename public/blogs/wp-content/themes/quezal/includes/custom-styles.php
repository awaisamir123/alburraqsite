...
function tcsn_custom_styles() {
	...
	.pricing .price { color: {$tcsn_theme_base_color}; }
	";
...
<?php } ?> 
<?php if ( $tcsn_option['tcsn_woocommerce_shop_columns'] == '4' ) : ?> .woocommerce ul.products li.product, .woocommerce-page ul.products li.product { width:22.15%; }
<?php elseif ( $tcsn_option['tcsn_woocommerce_shop_columns'] == '2' ) : ?> .woocommerce ul.products li.product, .woocommerce-page ul.products li.product { width:48.1%; }
<?php else : ?> .woocommerce ul.products li.product, .woocommerce-page ul.products li.product { width:30.8%; }
<?php endif ?> 
<?php if ( $tcsn_option['tcsn_woocommerce_related_products_column'] == '4' ) : ?> .woocommerce .related ul li.product, .woocommerce .related ul.products li.product, .woocommerce .upsells.products ul li.product, .woocommerce .upsells.products ul.products li.product, .woocommerce-page .related ul li.product, .woocommerce-page .related ul.products li.product, .woocommerce-page .upsells.products ul li.product, .woocommerce-page .upsells.products ul.products li.product { width:22.15%; }
<?php elseif ( $tcsn_option['tcsn_woocommerce_related_products_column'] == '2' ) : ?> .woocommerce .related ul li.product, .woocommerce .related ul.products li.product, .woocommerce .upsells.products ul li.product, .woocommerce .upsells.products ul.products li.product, .woocommerce-page .related ul li.product, .woocommerce-page .related ul.products li.product, .woocommerce-page .upsells.products ul li.product, .woocommerce-page .upsells.products ul.products li.product { width:48.1%; }
<?php else : ?> .woocommerce .related ul li.product, .woocommerce .related ul.products li.product, .woocommerce .upsells.products ul li.product, .woocommerce .upsells.products ul.products li.product, .woocommerce-page .related ul li.product, .woocommerce-page .related ul.products li.product, .woocommerce-page .upsells.products ul li.product, .woocommerce-page .upsells.products ul.products li.product { width:30.8%; }
<?php endif ?>
<?php if( $tcsn_option['tcsn_show_retina_logo'] == true && $tcsn_option['tcsn_image_retina_logo'] != "" ) { ?>
...
<?php 
echo "\n".'<link rel="stylesheet" href="'. get_template_directory_uri() .'/css/custom-override.css?ver=' . THEME_VERSION . '" media="all" />'."\n";
