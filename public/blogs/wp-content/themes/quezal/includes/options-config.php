...
<?php
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
                        ...
                        'title'         => __('Margin top to Sidebar', 'tcsn_theme'),
                        'subtitle'      => '',
            ...
            $this->sections[] = array(
                ...
                'fields'	=> array(
				   ...
				   array(
					...
					array(
                        'id'       => 'tcsn_show_retina_logo',
						'type'     => 'switch',
						'title'    => __('Show Retina Logo', 'tcsn_theme'),
						'subtitle' => '',
						'default'  => true,
                    ),
					array(
                        ...
                        'type'		=> 'media',
						'url'		=> true,
                        'title'     => __('Image For Retina Logo', 'tcsn_theme'),
                        'desc'      => '',
                        'subtitle'	=> __('Upload logo.', 'tcsn_theme'),
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
					...
					array(
                        'id'       => 'tcsn_post_social_share',
						'type'     => 'switch',
						'title'    => __('Show Social Share', 'tcsn_theme'),
						'subtitle' => '',
						'default'  => true,
                    ),
					array(
						'id'       => 'tcsn_show_post_social_share',
						'type'     => 'checkbox',
						'title'    => __('Select for Share', 'tcsn_theme'),
						'desc'     => __('Selected will get displayed in Share Box on single post', 'tcsn_theme'),
						'options'  => array(
							'1' => 'Facebook',
							'2' => 'Twitter',
							'3' => 'Google plus',
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
					array(
                        'id'        => 'tcsn_portfolio_title',
                        'type'      => 'text',
                        'title'     => __('Portfolio Page Title', 'tcsn_theme'),
                         'desc'		=> __('This will be applied for single portfolio item.', 'tcsn_theme'),
                        'default'   => 'Portfolio',
                    ),	
					array(
			...
			// CPT
            $this->sections[] = array(
                'title'     => __('Custom Post Types', 'tcsn_theme'),
                'desc'      => '',
                'icon'      => 'el-icon-cog',
                'fields'    => array(	
					array(
                        'id'        => 'tcsn_team_title',
                        'type'      => 'text',
                        'title'     => __('Team Page Title', 'tcsn_theme'),
                         'desc'		=> __('This will be applied for single team member.', 'tcsn_theme'),
                        'default'   => 'Our Team',
                    ),	
					array(
                        'id'        => 'tcsn_testimonial_title',
                        'type'      => 'text',
                        'title'     => __('Testimonial Page Title', 'tcsn_theme'),
                         'desc'		=> __('This will be applied for single testimonial.', 'tcsn_theme'),
                        'default'   => 'Reviews',
                    ),	
                ),
            );  
			...
			// Woocommerce
            $this->sections[] = array(
                'title'     => __('Woocommerce', 'tcsn_theme'),
                'desc'      => '',
                'icon'      => 'el-icon-cog',
                'fields'    => array(
					array(
                        'id'        => 'tcsn_woocommerce_shop_title',
                        'type'      => 'text',
                        'title'     => __('Shop Page Title', 'tcsn_theme'),
                        'validate'  => '',
                        'default'   => 'Products',
                    ),
					array(
                        'id'        => 'tcsn_shop_layout',
                        'type'      => 'select',
                        'title'     => __('Select Shop Layout', 'tcsn_theme'),
                        'subtitle'  => '',
                        'desc'      => '',
                        'options'   => array(
                            'tcsn-shop-full-width'		=> 'Full Width', 
							'tcsn-shop-with-sidebar'	=> 'With Sidebar',
                        ),
                        'default'   => 'tcsn-shop-with-sidebar'
                    ),
					array(
                        'id'        => 'tcsn_shop_sidebar',
                        'type'      => 'select',
                        'title'     => __('Sidebar Position', 'tcsn_theme'),
                        'subtitle'  => '',
                        'desc'      => __('Select shop sidebar position.', 'tcsn_theme'),
                        'options'   => array(
                            'tcsn-shop-sidebar-left'	=> 'Sidebar Left', 
							'tcsn-shop-sidebar-right'	=> 'Sidebar Right',
                        ),
                        'default'   => 'tcsn-shop-sidebar-right'
                    ),
					array(
                        'id'	=> 'tcsn-product-field',
                        'type'	=> 'info',
                        'desc'	=> __('Product Page', 'tcsn_theme')
                    ),
					array(
                        'id'        => 'tcsn_product_layout',
                        'type'      => 'select',
                        'title'     => __('Select Product Page Layout.', 'tcsn_theme'),
                        'subtitle'  => '',
                        'desc'      => '',
                        'options'   => array(
                            'tcsn-product-full-width'   => 'Full Width', 
							'tcsn-product-with-sidebar' => 'With Sidebar',
                        ),
                        'default'   => 'tcsn-product-with-sidebar'
                    ),
					array(
                        'id'        => 'tcsn_product_sidebar',
                        'type'      => 'select',
                        'title'     => __('Sidebar Position', 'tcsn_theme'),
                        'subtitle'  => '',
                        'desc'      => __('Select sidebar position.', 'tcsn_theme'),
                        'options'   => array(
                            'tcsn-product-sidebar-left'  => 'Sidebar Left', 
							'tcsn-product-sidebar-right' => 'Sidebar Right',
                        ),
                        'default'   => 'tcsn-product-sidebar-right'
                    ),
					array(
                        'id'        => 'tcsn_woocommerce_shop_columns',
                        'type'      => 'select',
                        'title'     => __('Shop Columns', 'tcsn_theme'),
                        'subtitle'  => '',
                        'desc'      => __('', 'tcsn_theme'),
                        'options'   => array(
                            '2'	=> '2', 
					...
					array(
                        'id'	=> 'tcsn-related-product-field',
                        'type'	=> 'info',
                        'desc'	=> __('Related Products', 'tcsn_theme')
                    ),
					array(
                        'id'        => 'tcsn_woocommerce_related_products_column',
                        'type'      => 'select',
                        'title'     => __('Related Products Columns', 'tcsn_theme'),
                        'subtitle'  => '',
                        'desc'      => __('', 'tcsn_theme'),
                        'options'   => array(
							'1'	=> '1', 
					...
					array(
                        'id'        => 'tcsn_woocommerce_related_products',
                        'type'      => 'text',
                        'title'     => __('Number of Related Products', 'tcsn_theme'),
						'subtitle'  => '',
                        'desc'      => '',
                        'default'   => '3',
                    ),
					array(
                        'id'	=> 'tcsn-ajax-cart-field',
                        'type'	=> 'info',
                        'desc'	=> __('Cart with Dropdown in Topbar', 'tcsn_theme')
                    ),
					array(
                        'id'       => 'tcsn_show_ajax_cart',
						'type'     => 'switch',
						'title'    => __('Show Cart with Dropdown in Topbar', 'tcsn_theme'),
						'subtitle' => '',
						'default'  => true,
                    ),
					array(
                        'id'            => 'tcsn_ajax_cart_padding',
                        'type'          => 'spacing',
                        'output'        => array('.shopping-cart-dropdown'), // An array of CSS selectors to apply this font style to
                        'mode'          => 'padding',    // absolute, padding, margin, defaults to padding
                        'all'           => false,        // Have one field that applies to all
                        'top'           => true,     // Disable the top
                        'right'         => false,     // Disable the right
                        ...
                        'units_extended'    => 'false',  // Allow users to select any type of unit
                        'display_units' => 'true',   // Set to false to hide the units if the units are specified
                        'title'         => __('Dropdown Align', 'tcsn_theme'),
                        'subtitle'      => '',
                        'desc'          => __('In case if topbar height is more, adjust shopping cart dropdown to align well with bottom of topbar. No need of unit. It will be in px.', 'tcsn_theme'),
                        'default'       => array(
                            'padding-top'		=> '10', 
                        )
                    ),
					array(
                        'id'	=> 'tcsn-product-social-share-field',
                        'type'	=> 'info',
                        'desc'	=> __('Social Share', 'tcsn_theme')
                    ),
					array(
                        'id'       => 'tcsn_product_social_share',
						'type'     => 'switch',
						'title'    => __('Show Social Share', 'tcsn_theme'),
						'subtitle' => '',
						'default'  => true,
					...
					array(
						'id'       => 'tcsn_show_product_social_share',
						'type'     => 'checkbox',
						'title'    => __('Select for Share', 'tcsn_theme'),
						'desc'     => __('Selected will get displayed in Share Box on single product page', 'tcsn_theme'),
						'options'  => array(
							'1' => 'Facebook',
							'2' => 'Twitter',
							'3' => 'Google plus',
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
				 array(
                        ...
                        'subtitle'  => __("Paste your CSS Code here. <br><br> ** Always keep backup, in case of accidental 'Reset'. <br><br>Consider using child theme for easy theme update. <br><br> Refer help document for more info about where/how to edit styles.", 'tcsn_theme'),
                        'mode'      => 'css',
        ...
        public function setArguments() {
            ...
            $this->args = array(
                ...
                'google_api_key'	=> 'AIzaSyDGOsuhY9-rEwey4p9snt1Ipn4Ke3KdnBk', // Must be defined to add google fonts to the typography module
