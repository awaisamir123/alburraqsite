                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Create New Talent</h3>
                            </div>
                            <div class="panel-body">
                                <form class="form-horizontal" id="exampleStandardForm" method="post" action="{{route('talent.store')}}" autocomplete="off" enctype="multipart/form-data">
                                    {!! csrf_field() !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea rows="5" type="text" class="form-control " name="professional_bio" value=""
                                                              id="experience" placeholder="Enter professional bio">{{ old('professional_bio') }}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea rows="5" type="text" class="form-control " name="experience" value=""
                                                              id="experience" placeholder="Enter experience">{{ old('experience') }}</textarea>
