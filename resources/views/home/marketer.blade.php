...
<div id="page-content">
            ...
            <div class="nextPort">
                ...
                <p class="text-white">
                    <div class="w-50 headp1 fontsizeforheadsub">
                        Set up your team with us and compete your competitors with our talented Digital Marketers
                    </div>
                ...
                <div class="w-50">
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#hireus" class="btn btn-primary btn-alt active shadow btnpos ml-0">Click to Hunt your Team</a>
                </div>
    ...
    <div class="container mt-5 ">
        ...
        <div class="row">
            ...
            <section id="projects" data-isotope="load-simple" class="related padding-bottom-null" style="padding: 0 20px 50px 20px!important;">
                <div class="col-md-12 padding-leftright-null">
                    <div class="projects-items equal three-columns">
                        ...
                        <div class="single-item shop one-item design branding">
                            <div class="item">
                                <img src="{{ asset('design/icons/Tech/seo.png') }}" alt="">
                                <div class="content">
                                    <div>
                                        <h3>Search Engine Optimization</h3>
                                        <span class="price"></span>
                                    </div>
                                    <p>We have highly experienced result oriented SEO Experts in our team, who can help you improve your digital presence.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="single-item shop one-item design branding">
                    <div class="item">
                        <img src="{{ asset('design/icons/Tech/social-media.png') }}" alt="">
                        <div class="content">
                            <div>
                            ...
                            <p>
                            We offer you the right SEM professionals, who can bring the best results by implementing the best SEM strategies.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="single-item shop one-item design branding">
                    <div class="item">
                        <img src="{{ asset('design/icons/Tech/google-ads.png') }}" alt="">
                        <div class="content">
                            <div>
            ...
            <div class="modal-body pl-0 pr-0">
                <div class="container-fluid p-4">
                    ...
                    <form action="{{ route('addContact') }}" method="post">
                        @csrf
                        <input type="hidden" name="hire_type" value="Marketer">
                        <div class="row m-0">
