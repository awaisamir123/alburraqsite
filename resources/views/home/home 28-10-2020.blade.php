                        ...
                        <div class="text">
                            ...
                            <div class="container">
                               <div class="row no-margin wrap-slider">
                                   <div class="col-md-6 col-sm-6 col-xm-6 padding-leftright-null">
                                       <div id="flexslider" class="home">
                                           <ul class="slides">
                                               <li style="background-image:url(/homebanners/home-banner1.jpg)"></li>
                                               <li style="background-image:url(/homebanners/home-banner2.jpg)"></li>
                                               <li style="background-image:url(/homebanners/home-banner3.jpg)"></li>
                                           </ul>
                                       </div>
                                   </div>
                                   <div class="col-md-6 col-sm-6 col-xm-6 padding-leftright-null">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-md-12 col-xs-12 padding-leftright-null">
                                        <div id="counters" class="row padding-md-leftright-null padding-md text-center">
                                            <div class=" stat-counter    padding-md-leftright-null">
                                                <div class="statistic">
                                                    <i style="" class="material-icons color service home-icon-font">people</i>
                                            ...
                                            <div class="stat-counter   padding-md-leftright-null">
                                                <div class="statistic">
                                                    <i style="" class="material-icons color service home-icon-font">card_travel</i>
                                            ...
                                            <div class=" stat-counter  padding-md-leftright-null">
                                                <div class="statistic">
                                                    ...
                                                    <i style="" class="material-icons color service home-icon-font">work</i>
                                            ...
                                            <div class=" stat-counter   padding-md-leftright-null">
                                                <div class="statistic">
                                                    ...
                                                    <i style="" class="material-icons color service home-icon-font">grade</i>
                        ...
                        <div class="col-md-12 padding-leftright-null " style="margin-left: 8px;">
                            ...
                            <div class="col-md-4">
                                <div class="margin-md-bottom">
                                    ...
                                    <div style="margin-bottom: 20px" class="image textAlignment">
                                        <img style="" src="\icons\bulbicon.png" alt="bulbicon.png">
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div>
                                    ...
                                    <div style="margin-bottom: 20px" class="image textAlignment">
                                        <img style="" src="\icons\expert.png" alt="expert.png">
                                    </div>
            ...
            <div class="container">
                ...
                <div class="row padding-null" style="margin-left: 0px;margin-right: 0px">
                    <div class="col-md-6">
                        ...
                        <!-- Nav tabs -->
                        <div class="image">
                            <img class="img-responsive" style="margin-right: 5px;width: 100%" src="/homebanners/why-choose-us.png" alt="image 2">
                        </div>
...
{{--portfolio--}}
                        ...
                        @if(isset($portfolios))
                            @foreach($portfolios as $portfolio)
                                ...
                                <div class="single-item one-item design {{$portfolio->category->name}}">
                                    <div class="item ">
                                        <div class="image">
                                            <img style="width: 100%" src="/portfolioimages/{{$portfolio->featuredimage}}" alt="portfolioimages">
                                        </div>
                                        <div class="content">
                            ...
                            @if(isset($reviews))
                                @foreach($reviews as $review)
                                    <div class="item padding-leftright-null">
                                        <div>
                                            <img class="review-image" src="{{ asset('assets/img/man.png') }}" alt="man.png">
                                        </div>
        ...
        <div class="container" style="margin-bottom:70px;">
          <div id="owl-demo" style="margin: 50px 0 12px 0;">
            ...
            <!-- <div class="item"><img  src="/homebanners/zongo-logo.png" alt="Owl Image"></div>
            <div class="item" id="mandy"><img src="/homebanners/mandy-logo.png" alt="Owl Image"></div>
            <div class="item"><img src="/homebanners/pci-logo.png" alt="Owl Image"></div>
            <div class="item"><img src="/homebanners/autopartsway-logo.png" alt="Owl Image"></div> -->
            <div class="item"><img src="/partnerslogo/bsahab.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/khird.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/gilariver.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/50-beats-and-alcard.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/zongo.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/tradesales.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/superstore.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/rebooted-body.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/zong-and-event.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/prim-ed.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/pinef-and-safety.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/mandy.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/pci.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/orderly.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/one firm plates.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/cartoon-me.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/data-looksee.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/autoparts.png" alt="Owl Image"></div>
            <div class="item"><img src="/partnerslogo/zong-and-event.png" alt="Owl Image"></div>
