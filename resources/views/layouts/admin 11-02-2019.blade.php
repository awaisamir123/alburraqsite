...
<head>
    ...
    <title>Al-Burraq</title>

    {{--select2--}}
    <link   rel="stylesheet" type="text/css" href="{{asset('admin/select2.min.css')}}">

    <!-- Include Quill stylesheet -->
    <link href="https://cdn.quilljs.com/1.0.0/quill.snow.css" rel="stylesheet">


    <link   rel="stylesheet" type="text/css" href="{{asset('admin/assets/images/apple-touch-icon.png')}}">



    <link   rel="stylesheet" type="text/css" href="{{asset('admin/assets/images/favicon.ico')}}">

    <!-- Stylesheets -->
    <link   rel="stylesheet" type="text/css" href="{{asset('admin/global/css/bootstrap.min.css')}}">


    <link   rel="stylesheet" type="text/css" href="{{asset('admin/global/css/bootstrap-extend.min.css')}}">

    <link   rel="stylesheet" type="text/css" href="{{asset('admin/assets/css/site.min.css')}}">

    <!-- Plugins -->
    <link   rel="stylesheet" type="text/css" href="{{asset('admin/global/vendor/animsition/animsition.css')}}">

    <link   rel="stylesheet" type="text/css" href="{{asset('admin/global/vendor/asscrollable/asScrollable.css')}}">

    <link   rel="stylesheet" type="text/css" href="{{asset('admin/global/vendor/switchery/switchery.css')}}">

    <link   rel="stylesheet" type="text/css" href="{{asset('admin/global/vendor/intro-js/introjs.css')}}">

    <link   rel="stylesheet" type="text/css" href="{{asset('admin/global/vendor/slidepanel/slidePanel.css')}}">

    <link   rel="stylesheet" type="text/css" href="{{asset('admin/global/vendor/flag-icon-css/flag-icon.css')}}">

    <link   rel="stylesheet" type="text/css" href="{{asset('admin/global/vendor/waves/waves.css')}}">

    <link   rel="stylesheet" type="text/css" href="{{asset('admin/global/vendor/chartist/chartist.css')}}">

    <link   rel="stylesheet" type="text/css" href="{{asset('admin/global/vendor/jvectormap/jquery-jvectormap.css')}}">

    <link   rel="stylesheet" type="text/css" href="{{asset('admin/global/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.css')}}">

    <link   rel="stylesheet" type="text/css" href="{{asset('admin/assets/examples/css/dashboard/v1.css')}}">

    <!-- Fonts -->
    <link   rel="stylesheet" type="text/css" href="{{asset('admin/global/fonts/material-design/material-design.min.css')}}">

    <link   rel="stylesheet" type="text/css" href="{{asset('admin/global/fonts/brand-icons/brand-icons.min.css')}}">
...
--}}
    ...
    <script async src="{{asset('admin/global/vendor/breakpoints/breakpoints.js')}}"></script>
    <script async src="{{asset('admin/global/vendor/html5shiv/html5shiv.min.js')}}"></script>
    <script async src="{{asset('admin/global/vendor/media-match/media.match.min.js')}}"></script>
    <script async src="{{asset('admin/global/vendor/respond/respond.min.js')}}"></script>

    <!-- Include the Quill library -->
    <script src="https://cdn.quilljs.com/1.0.0/quill.js"></script>

  {{--  <script async src="{{asset('admin/bootstrap.min.js')}}"></script>
    <script async src="{{asset('admin/jquery.min.js')}}"></script>--}}
...
<![endif]-->
    <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
        <div class="navbar-header">
            ...
            <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
                <img class="navbar-brand-logo" src="/admin/assets/images/logo.png" title="Remark">
                <span class="navbar-brand-text hidden-xs-down"> Al-burraq</span>
            </div>
        ...
        <div class="navbar-container container-fluid">
            ...
            <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
                                        ...
                                        <ul class="blocks-3">
                                            <li>
                                                <a class="thumbnail m-0" href="javascript:void(0)">
                                                    <img class="w-full" src="/admin/global/photos/placeholder.png" alt="..." />
                                                </a>
                                            </li>
                                            <li>
                                                <a class="thumbnail m-0" href="javascript:void(0)">
              ...
              <span class="avatar avatar-online">
                <img src="/admin/global/portraits/5.jpg" alt="...">
                <i></i>
              </span>
                        </a>
                        <div class="dropdown-menu" role="menu">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-media" role="menu">
                          ...
                          <span class="avatar avatar-sm avatar-online">
                            <img src="/admin/global/portraits/2.jpg" alt="..." />
                            <i></i>
                          </span>
                                                </div>
                                                <div class="media-body">
                          ...
                          <span class="avatar avatar-sm avatar-off">
                            <img src="/admin/global/portraits/3.jpg" alt="..." />
                            <i></i>
                          </span>
                                                </div>
                                                <div class="media-body">
                          ...
                          <span class="avatar avatar-sm avatar-busy">
                            <img src="/admin/global/portraits/4.jpg" alt="..." />
                            <i></i>
                          </span>
                                                </div>
                                                <div class="media-body">
                ...
                <div>
                    <ul class="site-menu" data-plugin="menu">
                        ...
                        <li class="site-menu-item has-sub">
                            ...
                            <ul class="site-menu-sub">
                                <li class="site-menu-item">
                                    <a class="animsition-link" href="{{route('portfolio.list')}}">
                                        <span class="site-menu-title">Portfolio List</span>
                                    </a>
                                </li>
                                <li class="site-menu-item">
                                    <a class="animsition-link" href="{{route('portfolio.create')}}">
                                        <span class="site-menu-title">Create Portfolio</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="site-menu-item has-sub">
                            ...
                            <ul class="site-menu-sub">
                                <li class="site-menu-item">
                                    <a class="animsition-link" href="{{route('message.index')}}">
                                        <span class="site-menu-title">New Messages</span>
                                    </a>
                                </li>
                                <li class="site-menu-item">
                                    <a class="animsition-link" href="{{route('message.responsemessages')}}">
                                        <span class="site-menu-title">Responsed Messages</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="site-menu-item has-sub">
                            <a href="javascript:void(0)">
                                <i class="site-menu-icon md-view-compact" aria-hidden="true"></i>
                                <span class="site-menu-title">Team Members</span>
                                <span class="site-menu-arrow"></span>
                            </a>
                            <ul class="site-menu-sub">
                                <li class="site-menu-item">
                                    <a class="animsition-link" href="{{route('team-member.index')}}">
                                        <span class="site-menu-title">Members List</span>
                                    </a>
                                </li>
                                <li class="site-menu-item">
                                    <a class="animsition-link" href="{{route('team-member.create')}}">
                                        <span class="site-menu-title">Create Member</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="site-menu-item has-sub">
                            ...
                            <ul class="site-menu-sub">
                                ...
                                <li class="site-menu-item">
                                    <a class="animsition-link" href="{{route('category.create')}}">
                                        <span class="site-menu-title">Create Category</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="site-menu-item has-sub">
                            ...
                            <ul class="site-menu-sub">
                                <li class="site-menu-item">
                                    <a class="animsition-link" href="{{route('review.index')}}">
                                        <span class="site-menu-title">Review List</span>
                                    </a>
                                </li>
                                <li class="site-menu-item">
                                    <a class="animsition-link" href="{{route('review.create')}}">
                                        <span class="site-menu-title">Create Review</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="site-menu-item has-sub">
                            ...
                            <ul class="site-menu-sub">
                                <li class="site-menu-item">
                                    <a class="animsition-link" href="{{route('tag.index')}}">
                                        <span class="site-menu-title">Tags List</span>
                                    </a>
                                </li>
                                <li class="site-menu-item">
                                    <a class="animsition-link" href="{{route('tag.create')}}">
                                        <span class="site-menu-title">Create Tag</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
    ...
    <!-- Core  -->
    <script async src="{{asset('admin/global/vendor/babel-external-helpers/babel-external-helpers.js')}}"></script>

    <script async src="{{asset('admin/global/vendor/jquery/jquery.js')}}"></script>

    <script async src="{{asset('admin/global/vendor/tether/tether.js')}}"></script>

    <script async src="{{asset('admin/global/vendor/bootstrap/bootstrap.js')}}"></script>

    <script async src="{{asset('admin/global/vendor/animsition/animsition.js')}}"></script>

    <script async src="{{asset('admin/global/vendor/mousewheel/jquery.mousewheel.js')}}"></script>

    <script async src="{{asset('admin/global/vendor/asscrollbar/jquery-asScrollbar.js')}}"></script>

    <script async src="{{asset('admin/global/vendor/asscrollable/jquery-asScrollable.js')}}"></script>

    <script async src="{{asset('admin/global/vendor/ashoverscroll/jquery-asHoverScroll.js')}}"></script>

    <script async src="{{asset('admin/global/vendor/waves/waves.js')}}"></script>

    <!-- Plugins -->
    <script async src="{{asset('admin/global/vendor/switchery/switchery.min.js')}}"></script>

    <script async src="{{asset('admin/global/vendor/intro-js/intro.js')}}"></script>

    <script async src="{{asset('admin/global/vendor/screenfull/screenfull.js')}}"></script>

    <script async src="{{asset('admin/global/vendor/slidepanel/jquery-slidePanel.js')}}"></script>

    <script async src="{{asset('admin/global/vendor/chartist/chartist.min.js')}}"></script>

    <script async src="{{asset('admin/global/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.min.js')}}"></script>


    @if(url()->current() == route('home'))


        <script async src="{{asset('admin/global/vendor/jvectormap/jquery-jvectormap.min.js')}}"></script>

        <script async src="{{asset('admin/global/vendor/jvectormap/maps/jquery-jvectormap-world-mill-en.js')}}"></script>

{{--
        <script async src="{{asset('admin/assets/examples/js/dashboard/v1.js')}}"></script>
--}}


    @endif

    <script async src="{{asset('admin/global/vendor/matchheight/jquery.matchHeight-min.js')}}"></script>


    <script async src="{{asset('admin/global/vendor/peity/jquery.peity.min.js')}}"></script>

    <!-- Scripts -->
    <script async src="{{asset('admin/global/js/State.js')}}"></script>

    <script async src="{{asset('admin/global/js/Component.js')}}"></script>

    <script async src="{{asset('admin/global/js/Plugin.js')}}"></script>

    <script async src="{{asset('admin/global/js/Base.js')}}"></script>

    <script async src="{{asset('admin/global/js/Config.js')}}"></script>

    <script async src="{{asset('admin/assets/js/Section/Menubar.js')}}"></script>

    <script async src="{{asset('admin/assets/js/Section/GridMenu.js')}}"></script>

    <script async src="{{asset('admin/assets/js/Section/Sidebar.js')}}"></script>

    <script async src="{{asset('admin/assets/js/Section/PageAside.js')}}"></script>

    <script async src="{{asset('admin/assets/js/Plugin/menu.js')}}"></script>

    <script async src="{{asset('admin/global/js/config/colors.js')}}"></script>

    <script async src="{{asset('admin/assets/js/config/tour.js')}}"></script>

  {{--  <script>
        Config.set('assets', '../assets');
    </script>--}}
    <!-- Page -->
    <script async src="{{asset('admin/assets/js/Site.js')}}"></script>

    <script async src="{{asset('admin/global/js/Plugin/asscrollable.js')}}"></script>

    <script async src="{{asset('admin/global/js/Plugin/slidepanel.js')}}"></script>

    <script async src="{{asset('admin/global/js/Plugin/switchery.js')}}"></script>

    <script async src="{{asset('admin/global/js/Plugin/matchheight.js')}}"></script>

    <script async src="{{asset('admin/global/js/Plugin/jvectormap.js')}}"></script>

    <script async src="{{asset('admin/global/js/Plugin/peity.js')}}"></script>

    <script async src="{{asset('admin/assets/examples/js/dashboard/v1.js')}}"></script>

    {{--select2--}}
    <script async src="{{asset('admin/select2.min.js')}}"></script>
    <script  src="{{ asset('admin/global/vendor/select2/select2.css') }}" ></script>
    <script  src="{{ asset('admin/global/vendor/select2/select2.full.js') }}" ></script>
    <script  src="{{ asset('admin/global/vendor/select2/select2.js') }}" ></script>
