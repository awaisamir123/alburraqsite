...
<![endif]-->
    <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
        <div class="navbar-header">
            ...
            <div class="navbar-brand navbar-brand-center " style="" >
                <a href="{{route('home')}}">
                    <img style="    margin-top: 3px; margin-left: 10px;"  class="navbar-brand-logo" src="/admin/adminlogo32.png" {{--title="Remark"--}}>    </a>
                <span class="navbar-brand-text hidden-xs-down" style="color: #60a14e;margin-top: 3px"><a    style="color: #60a14e;margin-top: 3px"
                 href="/admin/dashboard">Al-Burraq</a></span>
            </div>
        ...
        <div class="navbar-container container-fluid">
            ...
            <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
              ...
              <span class="avatar avatar-online">
                <img src="/assets/img/165pict--customer-male-ivr-people-vector-stencils-library.png" alt="...">
                <i></i>
              </span>
                        </a>
                        <div class="dropdown-menu" role="menu">
                    ...
                    <ul class="site-menu" data-plugin="menu">
                        ...
                        <li class="site-menu-item {{--active--}}">
                            <a {{--class="animsition-link"--}} href="{{route('home')}}">
                                <i class="fas fa-home site-menu-icon"></i>
                        ...
                        <li class="site-menu-item has-sub">
                            <a href="{{route('portfolio.list')}}">
                                <i class="fas fa-project-diagram site-menu-icon"></i>
                        ...
                        <li class="site-menu-item has-sub">
                            <a  href="{{route('message.index')}}">
                                <i class="fas fa-envelope-square site-menu-icon"></i>
                        ...
                        <li class="site-menu-item has-sub">
                            <a href="{{route('team-member.index')}}">
                                <i class="fas fa-users site-menu-icon"></i>
                        ...
                        <li class="site-menu-item has-sub">
                            <a href="{{route('hire-developer.index')}}">
                                <i class="fa-atom fas site-menu-icon"></i>
                                <span class="site-menu-title">Hire Developer</span>
                            </a>
    ...
    <!-- End Page -->
    <!-- Footer -->
    <footer hidden id="wrapper"   class="site-footer  ">
        ...
        <div class="site-footer-right">
            Crafted with <i class="red-600 icon md-favorite"></i> by <a href="/">Al-Burraq</a>
        </div>
    </footer>
    <!-- Core  -->
    ...
    <script  src="{{asset('admin/global/vendor/tether/tether.js')}}"></script>
    ...
    <script  src="{{asset('admin/global/vendor/ashoverscroll/jquery-asHoverScroll.js')}}"></script>

    <script  src="{{asset('admin/global/vendor/waves/waves.js')}}"></script>

    <!-- Plugins -->
    <script  src="{{asset('admin/global/vendor/switchery/switchery.min.js')}}"></script>
    ...
    @if(url()->current() == route('home'))
        ...
        <script  src="{{asset('admin/global/vendor/chartist/chartist.min.js')}}"></script>

        <script  src="{{asset('admin/global/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.min.js')}}"></script>

    @endif

    <script  src="{{asset('admin/global/vendor/jvectormap/jquery-jvectormap.min.js')}}"></script>

    <script  src="{{asset('admin/global/vendor/jvectormap/maps/jquery-jvectormap-world-mill-en.js')}}"></script>

    <script  src="{{asset('admin/global/vendor/matchheight/jquery.matchHeight-min.js')}}"></script>


    <script  src="{{asset('admin/global/vendor/peity/jquery.peity.min.js')}}"></script>
    {{--plugin--}}

    <!-- Scripts -->
    <script  src="{{asset('admin/global/js/State.js')}}"></script>
  ...
  {{--  <script>
    ...
    <script  src="{{asset('admin/global/js/Plugin/matchheight.js')}}"></script>

    <script  src="{{asset('admin/global/js/Plugin/jvectormap.js')}}"></script>

    <script  src="{{asset('admin/global/js/Plugin/peity.js')}}"></script>
  ...
  {{--  <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.10.19/js/jquery.dataTables.js"></script>--}}
    ...
    <script src="/admin/global/vendor/datatables.net-select-bs4/dataTables.select.js"></script>
   ...
   /*     $("#activitiesTable").DataTable(function(){
            responsive:true
        });
        $('#userlocation').DataTable();
        $('#invitationsTable').DataTable();
        $("#sponsorTable").DataTable();
        $('#teamsTable').DataTable();
        $('#eventFields').DataTable();
