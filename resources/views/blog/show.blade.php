                ...
                <div class="col-md-12 padding-leftright-null">
                    <div id="page-header">
                        <div class="text text-center">
                            <h1 class="margin-bottom-small">{{$blog->post_title}}<span class="color">.</span></h1>
                            <span class="post-meta">{{--News \--}} {{$blog->post_date}}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="home-wrap" class="content-section">
                ...
                <div class="row no-margin wrap-text padding-onlytop-sm">
                    <div class="col-md-12 padding-leftright-null">
                        <div class="text small padding-topbottom-null">
                            <img  src="{{$blog->guid}}" alt="" class="img-post">
                        </div>
                    </div>
                </div>
            </div>--}}
            ...
            <div class="container">
                <div class="row no-margin wrap-text padding-bottom-null padding-onlytop-lg">
                    <div class=" {{--col-md-offset-2--}} padding-leftright-null">
                        <div class="text small padding-topbottom-null">
                            <p>{{--<span class="dropcap" data-dropcap="L">L</span>--}}
                                {!! $blog->post_content !!}
                            </p>
                                    ...
                                    <div role="tabpanel" class="tab-pane padding-md active" id="tab-one">
                                        <div class="comment">
                                            <div class="row margin-null">
                                                <div class="col-md-12 padding-leftright-null">
                                                    <img src="assets/img/comment3.jpg" alt="comment3.jpg">
                                                    <div class="content">
                                                        <div class="header">
                                        ...
                                        <div class="comment reply">
                                            <div class="row margin-null">
                                                <div class="col-md-10 col-md-offset-2 padding-leftright-null">
                                                    <img src="assets/img/comment1.jpg" alt="comment1.jpg">
                                                    <div class="content">
                                                        <div class="header">
                                                                    <span class="comment-author">
                                                                        Joe Doe
                                        ...
                                        <div class="comment">
                                            <div class="row">
                                                <div class="col-md-12 padding-leftright-null">
                                                    <img src="assets/img/comment2.jpg" alt="comment2.jpg">
                                                    <div class="content">
                                                        <div class="header">
                                                                    <span class="comment-author">
                                                                        Jessica Brown
