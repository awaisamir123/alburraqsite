...
@section('page')
    <div class="page">
        ...
        <h1 style="text-align: center" >Welcome To Al-Burraq Technologies</h1>
        </div>
{{--
        <div class="page-content container-fluid">
            <div class="row" data-plugin="matchHeight" data-by-row="true">
                ...
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="card" id="widgetUserList">
                        <div class="card-header cover overlay">
                            <img class="cover-image h-200" src="/admin/assets//examples/images/dashboard-header.jpg"
                                 alt="..." />
                            ...
                            <ul class="list-group list-group-full list-group-dividered mb-0">
                                    ...
                                    <div class="media">
                                        <div class="pr-20">
                                            <a class="avatar avatar-lg" href="javascript:void(0)">
                                                <img class="img-responsive" src="/admin/global/portraits/1.jpg" alt="...">
                                            </a>
                                        </div>
                                ...
                                <li class="list-group-item">
                                    <div class="media">
                                        <div class="pr-20">
                                            <a class="avatar avatar-lg" href="javascript:void(0)">
                                                <img class="img-responsive" src="/admin/global/portraits/2.jpg" alt="...">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                ...
                                <li class="list-group-item">
                                    <div class="media">
                                        <div class="pr-20">
                                            <a class="avatar avatar-lg" href="javascript:void(0)">
                                                <img class="img-responsive" src="/admin/global/portraits/3.jpg" alt="...">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                ...
                                <div class="chat chat-left">
                                    <div class="chat-avatar">
                                        <a class="avatar" data-toggle="tooltip" href="#" data-placement="left" title="">
                                            <img src="/admin/global/portraits/5.jpg" alt="Edward Fletcher">
                                        </a>
                                    </div>
                                    <div class="chat-body">
                                ...
                                <div class="chat">
                                    <div class="chat-avatar">
                                        <a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="">
                                            <img src="/admin/global/portraits/4.jpg" alt="June Lane">
                                        </a>
                                    </div>
                                    <div class="chat-body">
                ...
                <div class="col-xl-4 col-lg-6">
                    ...
                    <div class="card card-shadow">
                        <div class="card-header cover overlay">
                            <div class="cover-background h-200" style="background-image: url('/admin/global/photos/placeholder.png')"></div>
                        </div>
