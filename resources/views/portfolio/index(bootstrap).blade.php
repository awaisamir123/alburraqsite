        ...
        <div id="home-wrap" class="content-section" style="padding: 0 30px">
            <div class="container">
                ...
                <section id="projects" data-isotope="load-simple" class="{{--page--}} padding-onlytop-md padding-onlybottom-lg">
                    ...
                    <!--  END Filters  -->
                    <div class="{{--projects-items equal three-columns--}} col-md-12 col-lg-12 col-sm-12">
                        <!-- Single Project -->
                        @if(isset($portfolios))
                            @foreach($portfolios as $portfolio)
                                <div class="{{--single-item one-item design--}}  col-sm-6 col-lg-4 col-md-4 {{$portfolio->category->name}}">
                                    <div class="item portfolioDesign">
                                        <div class="image">
