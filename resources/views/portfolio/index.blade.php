...
@section('meta')
    <meta name="description"
          content="USA website design company offering website designing, website developers USA. Wordpress website development, mobile application development and web designers.">
@endsection
                ...
                <div class="col-md-12 padding-leftright-null">
                    <div id="page-header">
                        <div class="text">
                            ...
                            <p class="heading left max full grey-dark">Al-Burraq Technologies architects design and
                                develops enterprise-class Mobile, Web, Social and Big Data solutions for some of the
                                world’s most innovative startup companies.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="home-wrap" class="content-section" style="padding: 0 30px;">
            <div class="container">
                ...
                <section id="projects" data-isotope="load-simple"
                         class="{{--page--}} padding-onlytop-md padding-onlybottom-md">
                    <!--  Filters  -->
                            ...
                            @foreach($portfolios as $portfolio)
                                ...
                                @endforeach
                                    ...
                                    <div class="item ">
                                        <div class="image">
                                            <img style="width: 100%;"
                                                 src="/portfolioimages/thumbnails/{{$portfolio->featuredimage}}" alt="">
                                        </div>
                                        <div class="content">
                                            <h3><strong>{{$portfolio->title}}</strong></h3>
                                            <p style="height: 100px;overflow: hidden"
                                               id="desc">{!! strip_tags($portfolio->description) !!}</p>
                                        </div>
                                        <a href="{{route('portfolio.detail',[strtolower(str_replace(' ','-' ,$portfolio->title)),$portfolio->id] )}}"
                                           class="link"></a>
                                    </div>
                                </div>
                        @endforeach
