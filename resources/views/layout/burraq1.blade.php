...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/bootstrap/bootstrap0.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/bootstrap/bootstrap1.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/bootstrap/bootstrap2.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/bootstrap/bootstrap3.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/bootstrap/bootstrap4.min.css')}}">
    ...
    <!-- Flexslider -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets/css/flexslider1.css')}}">
                ...
                <div id="sidemenu">
                            ...
                            <li class="submenu " aria-haspopup="true">
                                ...
                                <ul class="sub-menu " aria-haspopup="true">
                                    <li {{--style="width: 330px"--}}class="subMenu"><a
                                            href="{{route('services.webdesignanddevelopment')}}" class=
                                        @if(url()->current() == route('services.webdesignanddevelopment')) "active-item" @endif>Website
                                            Designing and Development</a></li>

                                    <li {{--style="width: 330px"--}}class="subMenu"><a
                                            href="{{route('services.softwaredevelopment')}}" class=
                                        @if(url()->current() == route('services.softwaredevelopment')) "active-item" @endif>Software
                                            Development</a></li>
                                ...
                                <!-- <li class="subMenu"><a href="{{route('services.laraveldevelopment')}}" class=
                                  ...
                                  <li class="subMenu"><a href="{{route('services.wordpressdevelopment')}}" class=
                                    ...
                                    <li class="subMenu"><a href="{{route('services.appdevelopment')}}" class=
                                        @if(url()->current() == route('services.appdevelopment')) "active-item" @endif>Mobile
                                ...
                                <!-- <li class="subMenu"><a href="{{route('services.machinelearning')}}" class=
                                    ...
                                    <li class="subMenu"><a href="{{route('services.artificialintelligence')}}" class=
                                        @if(url()->current() == route('services.artificialintelligence')) "active-item" @endif>Artificial
                                            Intelligence</a></li>

                                    <li class="subMenu"><a href="{{route('services.digitalmarketing')}}" class=
                                        @if(url()->current() == route('services.digitalmarketing')) "active-item" @endif>Digital
                                            Marketing</a></li>
                    ...
                    <div class="menu-holder mobile-menu">
                        <ul>
                            ...
                            <li>
                                <a href="{{route('contact-us.index')}}" class=
                                @if(url()->current() == route('contact-us.index')) "active-item" @endif >Become
                                    Partner</a>
                            </li>
    ...
    <div class="container">
        <div class="row no-margin">
            ...
            <div style="" class="col-md-4 text">
                ...
                <br>
                <p>{{--© 2019 Made with love by --}}Global Experience in Providing Enterprise Solutions to the
                    e-Commerce & Management System Companies.
                    <br>
                    We understand the value of customization and strive to continually deliver unprecedented solutions
            ...
            <div id="twitter-div" style="" class="col-md-4 text {{--small--}}">
                ...
                <script src="{{asset('assets/js/twitter/widgets.js')}}" charset="utf-8"></script>
            </div>
            <div style="" class="col-md-4 text {{--small--}}">
                ...
                <h4 style="padding: 06px 0 05px 0 !important"><strong> <a href="mailto:info@al-burraq.com"><i
                                    class="fa fa-envelope" aria-hidden="true"></i> info@al-burraq.com </a></strong></h4>


                <h4 style="padding: 06px 0 05px 0 !important"><i class="fa fa-phone" aria-hidden="true"></i><strong> +1 (301) 887 5877 </strong></h4>
                <h4 style="padding: 06px 0 05px 0 !important"><i class="fa fa-phone" aria-hidden="true"></i><strong> 1st floor, 49 Commercial Cavalry ground, Lahore Pakistan </strong></h4>
                ...
                <div style="/* margin-top: 10px*/ " class="row no-margin">
                    <ul class="social" style="float: none">
                        ...
                        <li><a href="https://www.facebook.com/alburraqtech"><i class="fa fa-facebook"
                                                                               aria-hidden="true"></i></a></li>
                        <li><a href="skype:/http:/alihassan869?chat"><i class="fa fa-skype" aria-hidden="true"></i></a>
                        </li>
                        <a href="{{route('privacy')}}"><h3>Privacy Policy</h3></a>
